class OTBHCConfig:
    ...
    newton_iterations = 5               # the number of Newton iterations used for optimizing the detection score
    ...
    init_GN_iter = 5                    # the number of Gauss-Newton iterations used in the first frame (only if the projection matrix is updated)
    ...
    scale_model_max_area = 32 * 16      # maximum area for the scale sample patch
