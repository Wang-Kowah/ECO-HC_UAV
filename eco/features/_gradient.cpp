...
static char module_docstring[] = 
	"This module provides an interface for calculating gradMag using C.";

static char gradMag_docstring[] = 
	"Calculate the gradient mag of images.";
// static char gradMagNorm_docstring[] = 
//	"Calculate the magnitute fo the gradient.";
static char fhog_docstring[] =
	"Calculate the gradient hist.";
// static char convTri_docstring[] =
//	"Calculate the conv tri."
...
static PyObject *_gradient_gradMag(PyObject *self, PyObject *args){
	...
	if (I_array == NULL){
		PyErr_SetString(PyExc_RuntimeError, "Couldn't get array.");
		Py_XDECREF(I_array);
		return NULL;
	}
